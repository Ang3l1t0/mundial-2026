/* ============================================================
   Mundial 2026 — Asignación oficial de terceros (Anexo C FIFA)
   495 combinaciones de los 8 mejores terceros → su cruce en 16avos.
   Clave: las 8 letras de grupo (ordenadas) cuyo 3.º clasifica.
   Valor: grupo-tercero que enfrenta cada ganador, en el orden
          [1A,1B,1D,1E,1G,1I,1K,1L] (los 8 cruces ganador-vs-tercero).
   Fuente: github.com/dw-football/wc2026-bracket (verificado 495/495
   contra el Anexo C oficial + openfootball/ESPN/CBS/Fox).
   ============================================================ */
const THIRD_ALLOC_ORDER = ["1A","1B","1D","1E","1G","1I","1K","1L"];
const THIRD_ALLOC_RAW = {
...
for (const k in THIRD_ALLOC_RAW) {
  const vals = THIRD_ALLOC_RAW[k].split(",");
  const m = {};
  THIRD_ALLOC_ORDER.forEach((w, i) => { m[w] = vals[i]; });
  THIRD_ALLOCATION[k] = m;
}

if (typeof window !== "undefined") {
  window.THIRD_ALLOCATION = THIRD_ALLOCATION;
  window.THIRD_ALLOC_ORDER = THIRD_ALLOC_ORDER;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = { THIRD_ALLOCATION, THIRD_ALLOC_ORDER };
}
