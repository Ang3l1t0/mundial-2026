...
const KO = {
  r32: [
    ...
    // Fechas y sedes según el calendario oficial FIFA 2026 (por número de partido).
    { id: "M74", a: { t: "W", g: "E" }, b: { t: "T", w: "1E" }, date: "29/06", city: "Boston",        side: "L" },
    { id: "M77", a: { t: "W", g: "I" }, b: { t: "T", w: "1I" }, date: "30/06", city: "Nueva York",    side: "L" },
    { id: "M73", a: { t: "R", g: "A" }, b: { t: "R", g: "B" }, date: "28/06", city: "L. Ángeles",    side: "L" },
    { id: "M75", a: { t: "W", g: "F" }, b: { t: "R", g: "C" }, date: "29/06", city: "Monterrey",     side: "L" },
    { id: "M83", a: { t: "R", g: "K" }, b: { t: "R", g: "L" }, date: "02/07", city: "Toronto",       side: "L" },
    { id: "M84", a: { t: "W", g: "H" }, b: { t: "R", g: "J" }, date: "02/07", city: "L. Ángeles",    side: "L" },
    { id: "M81", a: { t: "W", g: "D" }, b: { t: "T", w: "1D" }, date: "01/07", city: "San Francisco", side: "L" },
    { id: "M82", a: { t: "W", g: "G" }, b: { t: "T", w: "1G" }, date: "01/07", city: "Seattle",       side: "L" },
    // ---- Mitad DERECHA (→ semifinal M102) ----
    { id: "M76", a: { t: "W", g: "C" }, b: { t: "R", g: "F" }, date: "29/06", city: "Houston",       side: "R" },
    { id: "M78", a: { t: "R", g: "E" }, b: { t: "R", g: "I" }, date: "30/06", city: "Dallas",        side: "R" },
    { id: "M79", a: { t: "W", g: "A" }, b: { t: "T", w: "1A" }, date: "30/06", city: "Ciudad de Méx.", side: "R" },
    { id: "M80", a: { t: "W", g: "L" }, b: { t: "T", w: "1L" }, date: "01/07", city: "Atlanta",       side: "R" },
    { id: "M86", a: { t: "W", g: "J" }, b: { t: "R", g: "H" }, date: "03/07", city: "Miami",         side: "R" },
    { id: "M88", a: { t: "R", g: "D" }, b: { t: "R", g: "G" }, date: "03/07", city: "Dallas",        side: "R" },
    { id: "M85", a: { t: "W", g: "B" }, b: { t: "T", w: "1B" }, date: "02/07", city: "Vancouver",     side: "R" },
    { id: "M87", a: { t: "W", g: "K" }, b: { t: "T", w: "1K" }, date: "03/07", city: "Kansas City",   side: "R" },
  ],
  oct: [
    { id: "M89", a: { t: "M", m: "M74" }, b: { t: "M", m: "M77" }, date: "04/07", city: "Filadelfia",   side: "L" },
    { id: "M90", a: { t: "M", m: "M73" }, b: { t: "M", m: "M75" }, date: "04/07", city: "Houston",      side: "L" },
    { id: "M93", a: { t: "M", m: "M83" }, b: { t: "M", m: "M84" }, date: "06/07", city: "Dallas",       side: "L" },
    { id: "M94", a: { t: "M", m: "M81" }, b: { t: "M", m: "M82" }, date: "06/07", city: "Seattle",      side: "L" },
    { id: "M91", a: { t: "M", m: "M76" }, b: { t: "M", m: "M78" }, date: "05/07", city: "Nueva York",   side: "R" },
    { id: "M92", a: { t: "M", m: "M79" }, b: { t: "M", m: "M80" }, date: "05/07", city: "Ciudad de Méx.", side: "R" },
    { id: "M95", a: { t: "M", m: "M86" }, b: { t: "M", m: "M88" }, date: "07/07", city: "Atlanta",      side: "R" },
    { id: "M96", a: { t: "M", m: "M85" }, b: { t: "M", m: "M87" }, date: "07/07", city: "Vancouver",    side: "R" },
  ],
  cua: [
    { id: "M97",  a: { t: "M", m: "M89" }, b: { t: "M", m: "M90" }, date: "09/07", city: "Boston",       side: "L" },
    { id: "M98",  a: { t: "M", m: "M93" }, b: { t: "M", m: "M94" }, date: "10/07", city: "L. Ángeles",   side: "L" },
    { id: "M99",  a: { t: "M", m: "M91" }, b: { t: "M", m: "M92" }, date: "11/07", city: "Miami",        side: "R" },
    { id: "M100", a: { t: "M", m: "M95" }, b: { t: "M", m: "M96" }, date: "11/07", city: "Kansas City",  side: "R" },
  ],
  sem: [
